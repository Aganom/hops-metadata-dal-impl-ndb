...
) DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs COMMENT='NDB_TABLE=READ_BACKUP=1'
...
) /*!50100 TABLESPACE `ts_1` STORAGE DISK */  DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs COMMENT='NDB_TABLE=READ_BACKUP=1'
/*!50100 PARTITION BY KEY (inode_id) */$$
...
CREATE TABLE `hdfs_repair_jobs` (
  ...
  `job_id` int(11) NOT NULL,
  `path` varchar(767) NOT NULL,
  `in_dir` varchar(767) NOT NULL,
  `out_dir` varchar(767) NOT NULL,
  PRIMARY KEY (`jt_identifier`,`job_id`)
)  DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs$$
...
CREATE TABLE `yarn_resource` (
  ...
  PRIMARY KEY (`id`),
  INDEX `id` (`id` ASC)
)  DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs PARTITION BY KEY(id)$$
...
)  DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs PARTITION BY KEY(`rmnodeid`)$$
...
)  DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs PARTITION BY KEY(applicationid) $$
...
CREATE TABLE `yarn_applicationattemptstate` (
  ...
  `applicationattemptstate` VARBINARY(1767) NULL,
...
)  DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs PARTITION BY KEY(reservation_id_name) $$
